...
>
    ...
    <div class="space-y-6">
        <article>
            <a href="{{ route('blog.show', 'google-reviews-hair-salon') }}" class="group block rounded-xl border border-gray-100 bg-white p-6 shadow-sm hover:shadow-md hover:border-indigo-100 transition-all duration-200">
                ...
                <h2 class="text-xl font-bold group-hover:text-indigo-600 transition">How to Get More Google Reviews for Your Hair Salon (2026 Guide)</h2>
                <p class="text-gray-500 mt-2 leading-relaxed">Learn proven strategies to get more Google reviews for your hair salon. Discover when to ask clients, how to train your stylists, and how to build a review system that keeps your chair full.</p>
        ...
        <article>
            <a href="{{ route('blog.show', 'google-reviews-auto-repair-shop') }}" class="group block rounded-xl border border-gray-100 bg-white p-6 shadow-sm hover:shadow-md hover:border-indigo-100 transition-all duration-200">
                <div class="flex items-center gap-3 mb-3">
                    <span class="inline-flex items-center rounded-full bg-emerald-50 px-3 py-1 text-xs font-medium text-emerald-600">Industry Guide</span>
                    <time datetime="2026-04-10" class="text-sm text-gray-400">April 10, 2026</time>
                </div>
                <h2 class="text-xl font-bold group-hover:text-indigo-600 transition">How to Get More Google Reviews for Your Auto Repair Shop (2026 Guide)</h2>
                <p class="text-gray-500 mt-2 leading-relaxed">Learn proven strategies to get more Google reviews for your auto repair shop. Discover when to ask customers, how to train your service advisors, and how to build a review system that keeps your bays full.</p>
                <span class="inline-flex items-center mt-4 text-sm font-medium text-indigo-600 group-hover:gap-2 gap-1 transition-all">Read article <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg></span>
            </a>
        </article>
